...
class ImageFilterRepositoryImpl @Inject constructor(
    private val gpuImage: GPUImage,
    private val dispatcherProvider: DispatcherProvider
): ImageFilterRepository {
    override suspend fun getAllImageFilters(unfilteredBitmap: Bitmap): List<ImageFilter> {
        ...
        withContext(dispatcherProvider.io) {
            ...
            GPUImageFilter().also { filter ->
                gpuImage.setImage(unfilteredBitmap)
